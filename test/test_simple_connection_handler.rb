...
class TestConnectionHandler < Minitest::Test
  ...
  def test_connection_pools
    assert_deprecated do
      assert_equal({ ActiveRecord::Base.connection_pool.spec => @pool }, @handler.connection_pools)
    end
  end
end
